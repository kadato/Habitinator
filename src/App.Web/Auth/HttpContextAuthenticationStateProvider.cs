...
/// <summary>
///     Exposes the current HTTP user (Identity cookie) to Blazor so <c>AuthenticationStateProvider</c> matches the
///     request.
/// </summary>
/// <remarks>
...
public sealed class HttpContextAuthenticationStateProvider : AuthenticationStateProvider
{
    ...
    public override Task<AuthenticationState> GetAuthenticationStateAsync()
    {
        ...
        if (http is not null) _circuitUser = http.User;

        var user = _circuitUser
