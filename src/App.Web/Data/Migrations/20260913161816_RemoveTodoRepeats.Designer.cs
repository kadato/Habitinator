...
[Migration("20260913161816_RemoveTodoRepeats")]
partial class RemoveTodoRepeats
{
    /// <inheritdoc />
        ...
        modelBuilder.Entity("App.Web.Data.BoardRequestIdempotencyEntity", b =>
            {
                ...
                b.ToTable("BoardRequestIdempotencies");
            });
        ...
        modelBuilder.Entity("App.Web.Data.UserActivityEventEntity", b =>
            {
                ...
                b.HasIndex("UserId", "BoardItemId", "EventType", "OccurredAtUtc");
